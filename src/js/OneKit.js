...
const ADR_USER_FOLDER = 'ttfile://user/'
...
export default class OneKit {
  ...
  static new_tt_filePath(ext) {
    ...
    const tt_filePath = `${ADR_USER_FOLDER}${randomString}${ext}`
    return tt_filePath
  }
  ...
  static tt_filePath2wx_filePath(tt_filePath) {
    ...
    if (wx_storePath) {
      ...
      const wx_filePath = tt_filePath.replace(ADR_USER_FOLDER, WX_USER_FOLDER)
      return wx_filePath
    }
  }
